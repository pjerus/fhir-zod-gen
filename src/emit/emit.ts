...
/**
 * First line of every file this module emits. Exported because callers need
 * to recognize our own output on disk — generate.ts uses it to tell a stale
 * file from a previous batch apart from a hand-written file that merely
 * shares the directory (issue #50).
 */
export const GENERATED_FILE_MARKER = "// AUTO-GENERATED by fhir-zod-gen — do not edit by hand.";
